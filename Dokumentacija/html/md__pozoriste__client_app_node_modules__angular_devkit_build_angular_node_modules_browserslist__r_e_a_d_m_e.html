...
<title>Pozorište: Browserslist &lt;a href=&quot;https://cultofmartians.com/done.html&quot;&gt;&lt;img src=&quot;https://cultofmartians.com/assets/badges/badge.svg&quot; alt=&quot;Cult Of Martians&quot;/&gt;&lt;/a&gt;</title>
...
<p>Obviously you can <em>not</em> start with a <code>not</code> combiner, since there is no left-hand side query to&#160;combine&#160;it&#160;with.</p>
...
<td class="markdownTableBodyNone"><code>not</code> combiner <br  />
 (relative complement)   </td><td class="markdownTableBodyCenter"><img src="img/complement.svg" alt="Relative complement of queries" style="pointer-events: none;" class="inline"/>   </td><td class="markdownTableBodyNone"><code>&gt; .5% and not last 2 versions</code> <br  />
...
<li><code>dead</code>: browsers without official support or updates for 24 months. Right now it is <code>IE 10</code>, <code>IE_Mob 10</code>, <code>BlackBerry 10</code>, <code>BlackBerry 7</code>, <code>Samsung 4</code> and <code>OperaMobile 12.1</code>.</li>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md1212"></a>
&lt;tt&gt;.browserslistrc&lt;/tt&gt;</h2>
<p>Separated Browserslist config should be named <code>.browserslistrc</code> and have browsers queries split by a new line. Comments&#160;starts&#160;with&#160;<code>#</code>&#160;symbol:</p>
<div class="fragment"><div class="line"># Browsers that we support</div>
<div class="line"> </div>
<div class="line">last 1 version</div>
<div class="line">&gt; 1%</div>
...
<div class="line">These browsers account for 83.1% of all users in custom statistics</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md1217"></a>
