...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9030"></a>
API</h1>
<ul>
...
<li><p class="startli"><code>JsDiff.diffJson(oldObj, newObj[, options])</code> - diffs two <a class="el" href="class_j_s_o_n.html">JSON</a> objects, comparing the fields defined on each. The order of fields, etc does not matter in this comparison.</p>
<p class="startli">Returns a list of change objects (See below).</p>
</li>
...
<p class="startli">Return a <a class="el" href="class_j_s_o_n.html">JSON</a> object representation of the a patch, suitable for use with the <code>applyPatch</code> method. This parses to the same structure returned by <code>JsDiff.structuredPatch</code>.</p>
</li>
