...
</pre><h1><a class="anchor" id="autotoc_md8698"></a>
Usage</h1>
<div class="fragment"><div class="line">var dashdash = require(&#39;dashdash&#39;);</div>
<div class="line"> </div>
<div class="line">// Specify the options. Minimally `name` (or `names`) and `type`</div>
<div class="line">// must be given for each.</div>
<div class="line">var options = [</div>
<div class="line">    {</div>
<div class="line">        // `names` or a single `name`. First element is the `opts.KEY`.</div>
<div class="line">        names: [&#39;help&#39;, &#39;h&#39;],</div>
<div class="line">        // See &quot;Option specs&quot; below for types.</div>
<div class="line">        type: &#39;bool&#39;,</div>
<div class="line">        help: &#39;Print this help and exit.&#39;</div>
<div class="line">    }</div>
<div class="line">];</div>
<div class="line"> </div>
<div class="line">// Shortcut form. As called it infers `process.argv`. See below for</div>
<div class="line">// the longer form to use methods like `.help()` on the Parser object.</div>
<div class="line">var opts = dashdash.parse({options: options});</div>
<div class="line"> </div>
...
Longer Example</h1>
<p>A more realistic <a href="./examples/foo.js">starter script "foo.js"</a> is as follows. This also shows using <code>parser.help()</code> for formatted option help.</p>
<div class="fragment"><div class="line">var dashdash = require(&#39;./lib/dashdash&#39;);</div>
<div class="line"> </div>
<div class="line">var options = [</div>
<div class="line">    {</div>
...
</pre><h1><a class="anchor" id="autotoc_md8701"></a>
Bash completion</h1>
...
<li><code>interspersed</code> (Boolean). Optional. Default is true. If true this allows interspersed arguments and options. I.e.: <pre class="fragment">  node ./tool.js -v arg1 arg2 -h   # '-h' is after interspersed args
</pre> Set it to false to have '-h' <b>not</b> get parsed as an option in the above example.</li>
...
</pre><p> Set it to true to treat the unknown option as a positional argument.</p>
...
</pre><p> where <code>-x</code> and <code>-z</code> are unknown. There are multiple ways to interpret this:</p><ol type="1">
...
</pre><p> Both <code>node foo.js --dry-run</code> and <code>FOO_DRY_RUN=1 node foo.js</code> would result in <code>opts.dry_run = true</code>.</p>
