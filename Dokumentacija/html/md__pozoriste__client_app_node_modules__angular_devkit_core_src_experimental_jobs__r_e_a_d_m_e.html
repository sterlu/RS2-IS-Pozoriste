...
<title>Pozorište: Description</title>
...
<p>A job receives a single argument when scheduled and can also listen to an input channel. It can emit multiple outputs, and can also provide multiple output channels that emit asynchronous <a class="el" href="class_j_s_o_n.html">JSON</a> messages, which can be typed.</p>
...
Creating Jobs</h1>
<p>A job is at its core a function with a description object attached to it. The description object stores the <a class="el" href="class_j_s_o_n.html">JSON</a> schemas used to validate the types of the argument passed in, the input and output values. By default, a job accepts and can output any <a class="el" href="class_j_s_o_n.html">JSON</a> object.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md2250"></a>
Scheduling Jobs</h1>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2251"></a>
...
<h3><a class="anchor" id="autotoc_md2252"></a>
Dependencies</h3>
...
<div class="line"> </div>
<div class="line">scheduler.schedule(&#39;add&#39;, [1, 2, 3, 4]);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2257"></a>
